...
public class MsgIdGen {
	...
	private MsgIdGen(long workerId) {
	...
	public synchronized long nextId() {
		long timestamp = MsgIdGen.timeGen();
		...
		/*
		 * if (timestamp < this.lastTimestamp) { logger.error(String.format(
		 * "clock moved backwards.Refusing to generate id for %d milliseconds",
		 * (this.lastTimestamp - timestamp))); throw new
	...
	private static MsgIdGen flowIdWorker = new MsgIdGen(1);

	public static MsgIdGen getFlowIdWorkerInstance() {
		return flowIdWorker;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		MsgIdGen idWorker = MsgIdGen.getFlowIdWorkerInstance();
